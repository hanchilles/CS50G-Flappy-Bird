...
-- size of the gap between pipes --> Remove this to implement local random inside init()
...
function PipePair:init(y)
    ...
    -- TODO_1: Add random vertical difference between pipe pairs
    -- Source: https://www.gammon.com.au/scripts/doc.php?lua=math.random
    self.gap_height = math.random(80, 130)
